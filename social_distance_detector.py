...
ap.add_argument("-o", "--output", type=str, default="test.mp4",
...
time.sleep(1.0)
#vs = cv2.VideoCapture("vid_short.mp4")
writer = None
f = 0
...
try:
	...
	#		break
		...
		# resize the frame and then detect people (and only people no one else but only people) in it
